// Estados y municipios de Venezuela. Dato de referencia estático (casi inmutable):
// no vale la pena una tabla/endpoint en DB. Fuente: github.com/zokeber/venezuela-json
// (335 municipios, 24 estados). "Vargas" conserva el nombre del dataset (hoy La Guaira).
// ponytail: si algún día hay que gestionar esto en runtime, migrar a DB.

export const VENEZUELA: Record<string, readonly string[]> = {
  "Amazonas": [
    "Alto Orinoco",
    "Atabapo",
    "Atures",
